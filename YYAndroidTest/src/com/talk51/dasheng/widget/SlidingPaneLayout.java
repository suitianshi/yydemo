 ...
 * of only as a way to allow a two-pane layout normally used on larger screens to adapt to smal  ler
...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /** Allows the SlidingPaneLayout to be opened with a swipe
    ...
    /** Denies the SlidingPaneLayout to be opened with a swipe gesture
     *
     */
    ...
    public SlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setAccessibilityDelegate(this, new AccessibilityDelegateC());
    ...
    class AccessibilityDelegateC extends AccessibilityDelegateCompat {
        private final Rect mTmpRect = new Rect();
